...
(function (d) {
            ...
            var c = function (e) {
                for (var g = 0, h = e.length; g < h; g++) {
                    ...
                    if (f.key)
                        ...
                        else if (d.isPlainObject(f.key) && f.key.key === a && (!f.key.shiftKey || b.shiftKey)) if (!f.key.altKey || b.altKey) if (!f.key.ctrlKey || b.ctrlKey) (!f.key.metaKey || b.metaKey) && d(q).click();
    ...
    m.instanceSelector = function (a, b) {
        ...
        var c = [],
            ...
            g = function (a) {
                if (d.isArray(a)) for (var f = 0, q = a.length; f < q; f++) g(a[f]);
    ...
    m.buttonSelector = function (a, b) {
        for (
            var c = [],
                e = function (a, b, c) {
                    for (var d, g, f = 0, h = b.length; f < h; f++) if ((d = b[f])) (g = c !== l ? c + f : f + ""), a.push({ node: d.node, name: d.conf.name, idx: g }), d.buttons && e(a, d.buttons, g + "-");
                },
                g = function (a, b) {
                    var f,
                        h,
                    ...
                    if (d.isArray(a) || a instanceof d) {
                        ...
                        if (-1 !== a.indexOf(",")) {
                            ...
                            f = 0;
                            for (h = i.length; f < h; f++) i[f].name === k && c.push({ inst: b, node: i[f].node });
                        } else
                            d(f)
                                .filter(a)
                                .each(function () {
    ...
    d.extend(k, {
        collection: {
            ...
            action: function (a, b, c, e) {
                ...
                h && "absolute" === f
                    ? e._collection.css({ top: h.top + 5, left: h.left + 5 })
                    : "absolute" === f
                    ? (e._collection.css({ top: a.top + c.outerHeight(), left: a.left }), (c = a.left + e._collection.outerWidth()), (g = g.offset().left + g.width()), c > g && e._collection.css("left", a.left - (c - g)))
                    : ((a = e._collection.height() / 2), a > d(o).height() / 2 && (a = d(o).height() / 2), e._collection.css("marginTop", -1 * a));
        ...
        if (this.context.length) {
            for (
                var b = new i.Api(this.context[0]),
                    ...
                    h = b.cells(h, c.columns).render(c.orthogonal).toArray(),
                    f = a.length,
                    k = 0 < f ? h.length / f : 0,
                    j = Array(k),
                    m = 0,
            ...
            return { header: a, footer: g, body: j };
        }
    });
    var t = d("<textarea/>")[0];
